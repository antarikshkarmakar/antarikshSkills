...
- **Start of Session**: Read `MEMORY.md` first, then `AGENTS.md`. Check the last 5 entries of the daily log or the project file. Introduce yourself with a 1-paragraph summary. Ask if there are new updates.
- **End of Session**: Write daily log summary, update project files, refine `MEMORY.md` index, learn from corrections in `AGENTS.md`, and clear `inbox.md`.
