---
name: ak-skillset
description: Skill triage, deep analysis (11 thinking lenses), XML specs, multi-agent review synthesis, and context-based suggestions.
trigger: /ak-skillset
---
...
## 2. Deep Analysis Phase (11 Thinking Lenses)
...
## 3. Specification-to-Generation Flow (XML Spec)
...
## 4. Multi-Agent Synthesis (Review Duel)
